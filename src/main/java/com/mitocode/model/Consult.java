...
public class Consult {
    ...
    @ManyToOne // Muchas consultas un paciente
    ...
    @Column(length = 3, nullable = false) // numero de consultorio
    private String numConsult;

    @Column(nullable = false) // ISODate yyyy-MM-DDTHH:mm:ss por defecto, se le puede dar formato @DateTimeFormat(pattern = "")
